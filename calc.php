...
try {
  $date = $_POST["calculator-date"];
  $sum = intval($_POST["calculator-sum-range"]);
  $time = intval($_POST["calculator-time"]);
  $replenish = $_POST["calculator-replenish"];
  $replenishSum = intval($_POST["calculator-replenish-sum"]);  
